...
export default function AppartementS1Page() {
  const specifications = [
    { icon: Ruler, label: "Surface", value: "65 - 75 m²" },
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <Badge className="mb-4 bg-custom-beige-light text-custom-beige rounded-none">Appartement S+1</Badge>
              <h1 className="text-4xl font-bold text-gray-900 mb-6">Appartement 2 Pièces</h1>
              <p className="text-xl text-gray-600 mb-8">
                Idéal pour jeunes couples ou investissement locatif. Espace optimisé avec finitions haut de gamme et vue
                dégagée.
              </p>
            ...
            <div className="relative">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/S%2B1%202-DRl1jte6BhZODROY6icVjiBpKHogUi.jpeg"
              ...
              <div className="absolute top-4 right-4">
                <Badge className="bg-custom-beige text-white rounded-none">15 Unités Disponibles</Badge>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="rounded-none border-0 shadow-lg overflow-hidden">
              <div className="relative h-96">
                <Image
                  src="/apartment-floor-plan-s1.png"
                  alt="Plan 2D Appartement S+1"
                  fill
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Agencement optimisé avec salon lumineux, cuisine ouverte, chambre spacieuse et salle de bain moderne.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-none border-0 shadow-lg overflow-hidden">
              <div className="relative h-96">
                <Image src="/apartment-3d-view-s1.png" alt="Vue 3D Appartement S+1" fill className="object-cover" />
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Visualisation 3D</h3>
                <p className="text-gray-600">Rendu photoréaliste pour vous projeter dans votre futur espace de vie.</p>
              </CardContent>
            </Card>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 font-bold text-lg">
                  ...
                  <span className="text-custom-beige">65 - 75 m²</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/S%2B1%201-h0YkHs7YTQRwmuuXdjHSvNgfVeoln4.jpeg"
                  alt="Cuisine S+1 - Cuisine moderne avec îlot"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300"></div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/s1-bathroom-view.png"
                  alt="Salle de bain S+1"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300"></div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-64 overflow-hidden">
                <Image
                  src="/s1-night-view.png"
                  alt="Vue nocturne S+1"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select className="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-custom-beige focus:border-transparent">
                        <option>65 m² - 70 m²</option>
                        <option>70 m² - 75 m²</option>
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full rounded-none bg-custom-beige bg-custom-beige-hover"
                    >
                      Envoyer la Demande
                    </Button>
                  </form>
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">15 appartements S+1 disponibles</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">De 65 m² à 75 m²</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                ...
                <div className="bg-custom-beige-light p-6">
                  <h4 className="font-bold text-gray-900 mb-3">Appartement Témoin</h4>
                  <p className="text-gray-600 mb-4">
                    Visitez notre appartement témoin S+1 dès juillet 2026 pour découvrir les finitions et l'agencement.
                  </p>
                  <Button className="w-full rounded-none bg-custom-beige bg-custom-beige-hover">
                    Réserver une Visite
                  </Button>
                </div>
            ...
            <Link href="/logements/s2">
              <Card className="rounded-none border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <Button className="w-full rounded-none bg-custom-beige bg-custom-beige-hover">Découvrir</Button>
                </CardContent>
              </Card>
            </Link>
